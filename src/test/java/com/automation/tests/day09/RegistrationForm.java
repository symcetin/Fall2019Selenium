...
public class RegistrationForm {
    ...
    public void test1(){
        ...
        driver.findElement(lastNameBy).sendKeys("Blue");
        driver.findElement(userNameBy).sendKeys("testuser");
        driver.findElement(emailBy).sendKeys("abs@email.com");
        driver.findElement(passwordBy).sendKeys("1235y12334");
        driver.findElement(phoneBy).sendKeys("123-456-7860");

        driver.findElement(femaleBy).click();
        driver.findElement(birthdayBy).sendKeys("01/12/2008");
